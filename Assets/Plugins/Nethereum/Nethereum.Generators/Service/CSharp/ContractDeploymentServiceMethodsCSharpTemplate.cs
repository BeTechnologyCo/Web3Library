    ...
    public class ContractDeploymentServiceMethodsCSharpTemplate
    {
        ...
        public string GenerateMethods()
        {
            ...
            var sendRequestReceipt =
                $@"{SpaceUtils.TwoTabs}public static UniTask<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, {messageType} {messageVariableName}, CancellationTokenSource cancellationTokenSource = null)
{SpaceUtils.TwoTabs}{{
...
{SpaceUtils.TwoTabs}}}";
            ...
            var sendRequest =
                $@"{SpaceUtils.TwoTabs}public static UniTask<string> DeployContractAsync(Nethereum.Web3.Web3 web3, {messageType} {messageVariableName})
{SpaceUtils.TwoTabs}{{
...
{SpaceUtils.TwoTabs}}}";
            ...
            var sendRequestContract =
                $@"{SpaceUtils.TwoTabs}public static async UniTask<{_serviceModel.GetTypeName()}> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, {messageType} {messageVariableName}, CancellationTokenSource cancellationTokenSource = null)
{SpaceUtils.TwoTabs}{{
