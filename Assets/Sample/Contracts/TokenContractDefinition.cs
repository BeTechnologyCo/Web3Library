...
namespace TokenContract
{
    ...
    public partial class AmountDeposedFunction : AmountDeposedFunctionBase { }

    [Function("amountDeposed", "uint256")]
    public class AmountDeposedFunctionBase : FunctionMessage
    {
        [Parameter("address", "", 1)]
    ...
    public partial class AmountDeposedOutputDTO : AmountDeposedOutputDTOBase { }

    [FunctionOutput]
    public class AmountDeposedOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("uint256", "", 1)]
        public virtual BigInteger ReturnValue1 { get; set; }
    }
